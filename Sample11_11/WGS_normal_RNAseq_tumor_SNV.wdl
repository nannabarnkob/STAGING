...
######################
  ...
  # Convert GVCF to regular VCF for filtering purposes
  call GenotypeGVCF as GenotypeGVCF_normal {
    input: 
      GATK=gatk, 
      input_gvcf = MergeVCFs_normal.output_vcf,
      input_gvcf_index = MergeVCFs_normal.output_vcf_index, 
      output_basename = base_file_name_normal, 
      ref_dict = ref_dict, 
      ref_fasta = ref_fasta,
      ref_fasta_index = ref_fasta_index,  
 ...
 call VariantRecalibrator_SNP as VariantRecalibrator_SNP_normal {
   input: 
    ...
    dbSNP_vcf=dbSNP_vcf,
    GATK=gatk, 
    input_vcf=GenotypeGVCF_normal.output_vcf,
    input_vcf_index=GenotypeGVCF_normal.output_vcf_index
  }
